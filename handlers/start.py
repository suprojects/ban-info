...
def start(update, context):
    ...
    BUTTON_MARKUP = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="➕ Add me to your group ➕", url=helpers.create_deep_linked_url(
                    context.bot.username, "start", True))
            ],
        ]
    )
...
I can currently search in:
    ...
    6️⃣ <a href="https://t.me/OwlAntiSpam">OwlAntiSpam</a>
...
def start_group(update, context):
    ...
    update.message.reply_text(
        "I am Alive! 🤖", reply_markup=InlineKeyboardMarkup([[delete_button]]))
